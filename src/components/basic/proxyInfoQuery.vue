  ...
  <div class="userInfoQuery">
    <div class="textAL queryD">
      <el-form :inline="true" :model="formInline" class="demo-form-inline">
        <el-form-item>
          <el-button size="small" type="primary" @click="_add">新增代理</el-button>
        </el-form-item>
        <el-form-item label="">
          <el-input size="small" v-model="formInline.userName" placeholder="请输入代理名称" style="width:200px;">
    ...
    <div class="tableD">
      <el-table :data="tableData" :header-cell-style="{ background: 'rgba(250, 250, 250, 1)' }" style="width: 100%;font-size:13px;">
        ...
        <el-table-column prop="userId" label="代理ID" width="120"></el-table-column>
        <el-table-column prop="userName" label="代理名称" width="120"></el-table-column>
        ...
        <el-table-column label="代理状态" width="85">
          <template slot-scope='scope'>
    ...
    <el-dialog class="shopsAboutChange" :visible.sync="userChange">
      ...
      <el-form :model="ruleForm1">
        <el-form :model="ruleForm1" status-icon ref="ruleForm1" label-width="150px" class="demo-ruleForm1">
          <el-form-item label="代理名称:" :rules="[{required:true}]">
            <el-input type="text" :maxlength="20" v-model="ruleForm1.userName" placeholder="请输入代理名称" autocomplete="off" style="width: 348px;"></el-input>
          </el-form-item>
          <el-form-item label="代理状态	:" :rules="[{required:true}]">
    ...
    <el-dialog class="shopsAboutChange" :visible.sync="userPush">
      ...
      <el-form :model="ruleForm1">
        <el-form :model="ruleForm1" status-icon ref="ruleForm1" label-width="150px" class="demo-ruleForm1">
          <el-form-item label="代理名称	:" :rules="[{required:true}]">
            <el-input type="text" maxlength="30" v-model="ruleForm1.userName" placeholder="请输入代理名称	" autocomplete="off" style="width: 348px;"></el-input>
          </el-form-item>
          <el-form-item label="联系手机号:">
            <el-input type="number" maxlength="11" v-model="ruleForm1.userMobil" placeholder="请输入联系手机号" autocomplete="off" style="width: 348px;"></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    _addUser(val) {
      ...
      API.phLogin("/addAgen.do", data).then((res) => {
        if (res.data.code == "0000") {
    ...
    submitForm(val) {
      ...
      API.phLogin("/upAgen.do", data).then((res) => {
        if (res.data.code == "0000") {
    ...
    nextSubmit() {
      ...
      API.phLogin("/selAgenList.do", data).then((res) => {
        if (res.data.code == "0000") {
