  ...
  <div class="userInfoQuery">
    ...
    <div class="tableD">
      <el-table :data="tableData" :header-cell-style="{ background: 'rgba(250, 250, 250, 1)' }" style="width: 100%;font-size:13px;">
        ...
        <el-table-column prop="userId" label="商户ID" align="center" width="120"></el-table-column>
        <el-table-column prop="userName" label="商户名称" align="center"></el-table-column>
        ...
        <el-table-column prop="allFee" label="总手续费(U)" align="center"></el-table-column>
      </el-table>
      <div class="tableMsg">
...
export default {
  ...
  methods: {
    ...
    nextSubmit() {
      ...
      API.phLogin("/selSumS.do", data).then((res) => {
