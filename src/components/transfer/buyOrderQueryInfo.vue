  ...
  <div class="userInfoQuery">
    <div class="textAL queryD">
      <el-form :inline="true" :model="formInline" class="demo-form-inline">
        ...
        <el-form-item>
          ...
          <el-button size="small" icon="el-icon-download" style="background-color: #ff6838;color:white;" @click="_exportClick">
            导出</el-button>
        </el-form-item>
      </el-form>
    </div>
    <div class="tableD">
      <el-table :data="tableData" :header-cell-style="{ background: 'rgba(250, 250, 250, 1)' }" style="width: 100%;font-size:13px;">
        ...
        <el-table-column label="收款机构" width="120">
          <template slot-scope='scope'>
        ...
        <el-table-column label="操作" width="240">
          <template slot-scope="scope">
            <el-button-group>
              ...
              <el-button size="small" type="success" @click="_completePayBtn(scope.row)" :disabled="scope.row.orderStatus!=='待处理' && scope.row.orderStatus!=='处理中'">完成付款</el-button>
...
export default {
  ...
  methods: {
        ...
        .then(() => {
          ...
          API.phLogin("/txnExport.do", data).then((res) => {
            if (res.data.code == "0000") {
              ...
              link.setAttribute("download", "买入订单导出明细");
    ...
    nextSubmit() {
      ...
      API.phLogin("/selTxnListC.do", data).then((res) => {
        if (res.data.code == "0000") {
          let data = res.data.data;
...
.userInfoQuery /deep/ .instAbout2 .el-form-item__content {
  float: left;
  text-align: left;
